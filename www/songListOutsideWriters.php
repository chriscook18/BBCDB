...
<head>
	<title>Outside Writers Songs| The Beach Boys Cover Database</title>
...
$output .= "This page contains links to all original Beach Boys songs written exclusively by non-members in the database.";
$output .= $songList->radioDialsCSS();
$output .= $songList->getWriter("otherWritersSongs","OTHERWR");
