...
<head>
	<title>Blondie Chaplin Songs| The Beach Boys Cover Database</title>
...
$output .= "This page contains links to all songs in the database written by <a href='artist.php?359'>Blondie Chaplin</a>.";
$output .= $songList->radioDialsCSS();
$output .= $songList->getWriter("blondieSongs","BLONDIE");
