...
<head>
	<title>Brian Wilson Songs| The Beach Boys Cover Database</title>
...
$output .= "This page contains links to all songs in the database written by <a href='artist.php?222'>Brian Wilson</a>.";
$output .= $songList->radioDialsCSS();
$output .= $songList->getWriter("brianSongs","BRIAN");
